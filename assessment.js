...
const tweetDivided = document.getElementById('tweet-area');
    ...
    /**
     * 指定した要素の子どもを全て削除する
     * ＠pargm {HTMLElment} element HTMLの要素
     */
    function removeAllChildren(element) {
        while (element.firstChild) { // 子どもの要素が有る限り除去
...
const answers = [
    ...
    '{userName}のいいところは好奇心です。新しいことに向かっていく{userName}の心構えが多くの人に魅力に映ります。',
...
console.assert(
    ...
    '入力が同じ名前なら同じ診断結果の出力する処理が正しくありません'
);
